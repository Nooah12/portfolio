  ...
  return (
    <section id="top" className="flex min-h-[min(700px,100svh)] items-center py-28 md:py-20">
      <motion.div variants={container} initial="hidden" animate="show" className="w-full">
        ...
        <motion.h1 variants={item} className="mt-4 max-w-4xl font-Ovo text-5xl leading-[1.02] tracking-tight sm:text-6xl lg:text-7xl">I build things and learn constantly.</motion.h1>
