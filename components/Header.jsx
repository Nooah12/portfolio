  ...
  return (
    <section id="top" className="flex min-h-[min(700px,100svh)] items-center py-28 md:py-20">
      <div className="enter w-full">
        ...
        <h1 className="mt-4 max-w-4xl font-Ovo text-5xl leading-[1.02] tracking-tight sm:text-6xl lg:text-7xl">I&apos;m building things and learning constantly.</h1>
        <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 dark:text-white/70">I&apos;m a frontend developer fresh out of school, looking for my first role where I can build real things and keep growing.</p>
