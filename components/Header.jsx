  ...
  return (
    <section id="top" className="flex min-h-[min(700px,100svh)] items-center py-28 md:py-20">
      <motion.div variants={container} initial="hidden" animate="show" className="w-full">
        ...
        <motion.h1 variants={item} className="mt-4 max-w-4xl font-Ovo text-5xl leading-[1.02] tracking-tight sm:text-6xl lg:text-7xl">I build things and improve, one day at a time. </motion.h1>
        <motion.p variants={item} className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 dark:text-white/70">As an aspiring frontend developer, I&apos;m looking for my first role where I can contribute to real projects and continue to grow.</motion.p>
        <motion.div variants={item} className="mt-9 flex flex-wrap items-center gap-3">
          ...
          <a href="/noah-gordon-cv+personligt-brev.pdf" target="_blank" rel="noopener noreferrer" className="rounded-full border border-slate-300 px-6 py-3 text-sm font-semibold transition hover:border-slate-900 dark:border-white/30 dark:hover:border-white">Download resume</a>
