  ...
  return (
    <section id="top" className="flex min-h-[min(700px,100svh)] items-center py-28 md:py-20">
      <div className="enter w-full">
        ...
        <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 dark:text-white/70">As a frontend developer fresh out of school, I&apos;m looking for my first role where I can build real things and keep growing.</p>
